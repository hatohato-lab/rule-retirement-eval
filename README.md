...
|---|---|---|---|---|
| keep_table_unified | 21 | 1 | 20.7% | KEEP |
| no_delete_commands | 21 | 0 | 13.3% | 退役候補 |
```
...
このリポジトリ自体の設計書は、公開前に6レンズ査読（harness-lens-reviewer）にかけ、赤4件（統計的検出力不足・固定タクソノミー・完了条件の甘さ・過大な用語）を修正してから実装しています。経緯は `00_設計書/` を参照。
